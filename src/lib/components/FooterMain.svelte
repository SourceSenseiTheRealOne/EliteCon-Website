<script lang="ts">
	...
	export let bottomnav: Content.BottomnavigationDocument;
...
$: if (bottomnav.data.navigationcolumn)
    console.log(bottomnav.data.navigationcolumn, 'bottomnav.data.navigationcolumn');
        ...
        >
            <div class="col-span-full lg:col-span-2">
                ...
                <div class="mb-4 lg:-mt-2">
                    <PrismicImage class="lg:w-40 lg:h-16 w-fit h-16" field={bottomnav.data.logo} />
                </div>
                <!-- logo - end -->

                <p class="mb-6 text-gray-500 sm:pr-8 text-nowrap">
                    <PrismicRichText field={bottomnav.data.description} />
                </p>

                <div class=" w-full h-auto py-8 flex items-start justify-start gap-4 flex-wrap">
                    <button
                        class="w-10 h-10 flex items-center justify-center rounded-lg bg-white  shadow-gray-200 group transition-all duration-300"
                    >
                        <a href="https://www.facebook.com/eliteconinc?mibextid=LQQJ4d" target="_blank">
                            <svg
                    ...
                    <button
                        class="w-10 h-10 flex items-center justify-center group rounded-lg bg-white  shadow-gray-200 group transition-all duration-300"
                    >
                        <a href="https://www.instagram.com/elitecon_inc/" target="_blank">
                            <svg
                                class="transition-all duration-300 group-hover:scale-110"
                                width="28"
                                height="28"
                    ...
                    <button
                        class="w-10 h-10 flex items-center justify-center rounded-lg bg-white  shadow-gray-200 group transition-all duration-300"
                    >
                        <a href="https://www.tiktok.com/@elitecon_inc?_t=ZM-8t7p1ooV7Pq&_r=1" target="_blank">
                            <svg
                                class="transition-all duration-300 group-hover:scale-110"
                                width="28"
                                height="28"
                    ...
                    <button
                        class="w-10 h-10 flex items-center justify-center rounded-lg bg-white  shadow-gray-200 group transition-all duration-300"
                    >
                        <a href="https://www.youtube.com/@elite_con" target="_blank">
                            <svg
            ...
            <!-- nav - start -->
            {#each bottomnav.data?.navigationcolumn as item}
