...
<section
	...
	class="bg-black text-white px-24 py-20"
>
	<div class=" py-6 sm:py-8 lg:py-12 mt-8 mb-12">
		<div class="mx-auto max-w-screen-2xl px-4 md:px-8">
			<!-- text - start -->
			<div class="mb-10 md:mb-16">
				<h2 class="text-2xl lg:text-6xl mb-4 font-medium title-font text-orange-200 text-center">
					About Us
				</h2>
